"""
class InvariantPointAttention, IPABlock, IPATransformer is from https://github.com/lucidrains/invariant-point-attention/blob/main/invariant_point_attention/invariant_point_attention.py
"""
